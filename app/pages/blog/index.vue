  ...
  <div class="py-10">
    ...
    <div class="mb-12">
      ...
      <p class="mt-4 max-w-lg text-base leading-relaxed text-muted-foreground">
        Notes on backend development, developer tools, and things I learn along the way.
      </p>
    </div>
    ...
    <!-- <div class="w-[90%] max-w-5xl mx-auto">
      <div class="flex flex-col gap-6 stagger-children">
        <NuxtLink v-for="post in data?.posts" :key="post.id" :to="`/blog/${post.slug}`"
          ...
          <div
            class="table:w-[200px] table:h-[140px] movil:w-full movil:h-[200px] overflow-hidden rounded-xl flex-shrink-0">
            <img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
              :src="post.image.url" :alt="post.tittle" />
          </div>
          <div class="flex-1 flex flex-col gap-2">
            <h2
              class="font-ubuntu font-bold laptop:text-2xl table:text-xl movil:text-lg text-color group-hover:text-[#40CEF7] transition-colors duration-300">
              {{ post.tittle }}
            </h2>
          ...
          <div
            class="text-[#40CEF7] movil:hidden table:block transition-transform duration-300 group-hover:translate-x-2">
