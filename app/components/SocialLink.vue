...
import type { LinkSocial } from "~~/app/types";
interface Props {
  links: LinkSocial[];
}
...
<template>
  <ul
    class="movil:max-w-[300px] laptop:w-auto flex justify-center items-center"
  >
    <li
    ...
    >
      <a
        ...
        :href="social.link"
        target="_blank"
        :aria-label="`Joan Cruz' social page ${social.name}`"
      >
        <Icon
